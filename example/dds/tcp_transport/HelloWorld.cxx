...
{
    // m_index com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2de8284b
    m_index = 0;
    // m_message com.eprosima.idl.parser.typecode.StringTypeCode@396e2f39
    m_message ="";
    // m_data com.eprosima.idl.parser.typecode.ArrayTypeCode@a74868d
    memset(&m_data, 0, (4*1024*1024) * 1);
        ...
        size_t current_alignment)
{
    ...
    current_alignment += ((4*1024*1024) * 1) + eprosima::fastcdr::Cdr::alignment(current_alignment, 1);
...
void HelloWorld::data(
        const std::array<char, 4*1024*1024>& _data)
{
    m_data = _data;
}
 ...
 */
void HelloWorld::data(
        std::array<char, 4*1024*1024>&& _data)
{
 ...
 */
const std::array<char, 4*1024*1024>& HelloWorld::data() const
{
    return m_data;
}
 ...
 */
std::array<char, 4*1024*1024>& HelloWorld::data()
{
    return m_data;
}
