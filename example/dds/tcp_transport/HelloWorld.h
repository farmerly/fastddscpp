...
public:
     ...
     */
    eProsima_user_DllExport const std::array<char, 4*1024*1024>& data() const;

    /*!
     * @brief This function returns a reference to member data
     * @return Reference to member data
     */
    eProsima_user_DllExport std::array<char, 4*1024*1024>& data();
...
private:
    ...
    std::array<char, 4*1024*1024> m_data;
};
